...
const loadInitial=async()=>{//«
	...
	GLTFLoader.setBasisManager(new BasisManager(`/node/ogl/assets/libs/basis/BasisWorker.js`));

	gltf = await GLTFLoader.load(gl, `/node/ogl/assets/gltf/cottage-basis.glb`);
	addGLTF(gltf);
}//»
